  ...
  const handleUpload = async (e) => {
    ...
    await fileUploader(selectedFiles).then(async (res) => {
      ...
      try {
        ...
        const responseFormData = await axios.post(`${baseurl}/expense/create`, body);
        setPerson(null);
        setCompanyName(null);
        setdebittype(null);
        setCreateDate(null);
                    ...
                    <Col xs={12} md={6}>
                      <Form.Group id="pname" className="mb-4">
                        ...
                        <InputGroup>
                          ...
                          <Form.Control  type="date" placeholder="Amount" value={createdate} onChange={(e) => setCreateDate(e.target.value)} />
                        </InputGroup>
                      </Form.Group>
                    </Col>
                    ...
                    <Col xs={12} md={6}>
                      <Form.Group id="pname" className="mb-4">
                        ...
                        <InputGroup>
                          ...
                          <Form.Select required value={invoice} onChange={(e) => setInvoice(e.target.value)}>
                            <option value="">Select Option</option>
                            {/* Mapping through the arr array to generate options */}
