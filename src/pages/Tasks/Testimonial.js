...
export default () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://ab.execute-api.ap-south-1.amazonaws.com/production/api/uploadtestimonal', pageData, {
        headers: {
          Authorization: `${token}`
        }
      });
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`https://ab.execute-api.ap-south-1.amazonaws.com/production/api/delete/testimonal/${id}`, {
      headers: {
        Authorization: `${token}`
      }
    })
  ...
  useEffect(() => {
    axios.get('https://ab.execute-api.ap-south-1.amazonaws.com/production/api/get/testimonal')
      .then(response => {
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const response = await axios.put(`https://ab.execute-api.ap-south-1.amazonaws.com/production/api/update/testimonal/${editItemId}`, editData, {
        headers: {
          Authorization: `${token}`
        }
      });
